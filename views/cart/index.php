    ...
    <div class="basket-products">
        <?php $i = 0;
            ...
            $i += 1;?>
                <?php foreach($products as $product){?>
                    <?php if(Yii::$app->user->id === $user_basket_product->user_id && $product->id === $user_basket_product->product_id){ 
                            ...
                            <div class="basket-product-card">
                                ...
                                <div class="b-c-img"><img src="/products_img/<?= $product->img ?>" alt=""></div>
                                    <div class="b-c-info">
                                        ...
                                        <h5 class="b-c-price"><?= $product->price ?> ₽</h5>
                                    </div>
                                </a>
        ...
        <?php if($i === 0): ?>
           <div class="non-products">
                <div class="">В корзине пока пусто.</div>
            </div>
        <?php endif; ?>
    </div>
